...
interface NewArticleErrorPageProps {}

const NewArticleErrorPage: FC<NewArticleErrorPageProps> = ({}) => {
    return (
        <DashboardMain className="flex items-center justify-center">
            <div>
                <div className="mx-auto max-w-max rounded-xl border border-gray-300 p-3.5">
                    <CircleX className="size-7 text-gray-700" />
                </div>
                ...
                <p className=" mx-auto mt-4 max-w-[512px] text-center text-xl text-gray-600">
                    An error occurred while creating the article. Please try
                    again later.
                </p>
